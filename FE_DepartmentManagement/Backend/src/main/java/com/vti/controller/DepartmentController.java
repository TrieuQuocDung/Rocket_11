...
public class DepartmentController {
	...
	@GetMapping()
	public ResponseEntity<?> getAllDepartments(Pageable pageable ,@RequestParam(required = false)String search , DepartmentFilter filter) {
...
//	}
	...
	public ResponseEntity<?> existsByID(@PathVariable(name = "name") String name) {
